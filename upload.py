...
filename = "-".join(
    [project, ReleaseVersion(), "git" + GITVersion(), GITHash(), platform]
)
...
if "ftp_username" in os.environ:
    ...
    request = urllib.Request(
        "https://builds.limetech.io/upload.php?project=%s&branch=%s&filename=%s"
        % (project, GITBranch(), filename),
        open(filename, "rb"),
        headers={
