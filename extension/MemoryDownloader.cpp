 ...
 * "Source Engine," the "SourcePawn JIT," and any Game MODs that run on
 ...
 * AlliedModders LLC defines further exceptions, found in LICENSE.txt (as of
 * this writing, version JULY-31-2007), or
